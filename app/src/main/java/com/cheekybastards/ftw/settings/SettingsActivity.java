...
Preference.OnPreferenceChangeListener {
	...
	private static final String PP_PACKAGE = "com.cheekybastards.ftw";
	...
	private static final String PP_PREFS_CLASS = "com.cheekybastards.ftw.fragment.RootFileFragment";
	...
	public void onCreate(Bundle icicle)
	{
		...
		PPSettings = findPreference(PP_SETTINGS);
		PPSettings.setOnPreferenceClickListener(this);
		PPSettings.setEnabled(true);
	...
	private void displayFileManagerList() {
		...
		for (int p = 0 ; p < count ; p++) {
			...
			String description = (String) info.applicationInfo.loadDescription(pm);
